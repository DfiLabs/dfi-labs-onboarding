...
async function generateDetailedReportPDF(summary: ScreeningSummary): Promise<Buffer> {
  ...
  // Set up colors - DFI Labs theme (purple/blue gradients)
  const colors = {
    green: [39, 174, 96],
    amber: [243, 156, 18],
    red: [231, 76, 60],
  ...
  const databases = [
    ...
    { category: 'PEP Screening', sources: ['France RNE (Répertoire national des élus)', 'HATVP (Déclarations d\'intérêts)', 'European Parliament', 'OpenSanctions'] },
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="pdf-download">
        <strong>📄 Complete PDF Report Generated</strong>
        <p>Your detailed KYC/AML screening report is ready for download.</p>
        <p><a href="https://dfi-onboarding-dossiers-4d48c1e4662b.s3.eu-west-3.amazonaws.com/screening/${summary.caseId}/complete-report.pdf" target="_blank">📥 Download PDF Report</a></p>
